...
public class mail {
   public static void sendMail(String recepient,int code) throws Exception{
        ...
        String myAccountEmail="cinmeart99@gmail.com";
        String password="28421810";
...
"    <p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-family: 'Crimson Text', serif; font-size: 14px; line-height: 19.6px;\"><strong><span style=\"font-size: 22px; line-height: 30.8px;\">e_laab</span></strong></span></p>\n" +
